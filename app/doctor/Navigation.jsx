...
const Navigation = () => {
  ...
  return (
    ...
    >
      <CustomNavLink href="/doctor">
        <Icon name="home" size={20} />
        <span className="text-[8px] opacity-80">Doctor</span>
      </CustomNavLink>

      <CustomNavLink href="/doctor/consultations">
      ...
      <CustomNavLink href="/doctor/settings">
...
function CustomNavLink({ href, children }) {
  ...
  return (
    <Link
      href={href}
      className={`${pathname == href ? "text-[#1648CE]" : "text-[#929CAD]"
