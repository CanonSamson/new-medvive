...
const GenderPopUp = ({ settingsPup, setSettingsPup }) => {
  const { patientDetail, getPatientData, auth } = usePatient();
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      updateDB("patients", auth.currentUser.uid, { gender: gender });
      setSubmit(false);
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={onSubmit}
            className={` ${
              patientDetail.gender === gender ? "bg-gray-500" : "bg-primary"
