...
const PersonalInformation = () => {
  ...
  return (
    <div className=" flex flex-col min-h-screen pb-[200px] relative pt-[80px] ">
      <Image
        width={200}
        height={200}
      ...
      <DateOfBirthPopUp
        ...
        setSettingsPup={setSettingsPup}
      />
      <AddressPopUp settingsPup={settingsPup} setSettingsPup={setSettingsPup} />

      <GenderPopUp settingsPup={settingsPup} setSettingsPup={setSettingsPup} />
      <WeightPopUp settingsPup={settingsPup} setSettingsPup={setSettingsPup} />
      <HeightPopUp settingsPup={settingsPup} setSettingsPup={setSettingsPup} />
