...
const Dashoard = () => {
  const { greeting, patientDetail } = useUserAuth();
          ...
          <div className="relative h-[154px] overflow-hidden p-4 flex items-center rounded-xl mt-[20px]">
            <div className="z-10 w-[55%]">
              ...
              <p className="text-base">
                We provide the best quality medical services without additional
                cost.
              </p>
            </div>
            <Image
        ...
        <div className="relative z-20 mt-[10px]  grid gap-2">
          ...
          >
            ...
            <p className="text-base text-[#7B8D9E]">
              You haven`&apos;`t scheduled a consultation yet. Please schedule one.
            </p>
